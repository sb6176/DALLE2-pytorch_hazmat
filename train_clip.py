...
img_path = "./dataset/images/raw/image_0000.jpg"

image = preprocess(Image.open(img_path)).unsqueeze(0).cuda(device=device)
text = tokenizer(["2 organic-peroxide hazmat labels", "a pile of boxes in a warehouse", "a wood floor"]).cuda(device=device)
